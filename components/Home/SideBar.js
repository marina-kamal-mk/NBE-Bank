                ...
                <View>
                    <View style={styles.li}>
                        <View style={styles.img_cont}>
                            <Bar name="bar-graph" size={20} color="black" />
                        </View>
                        <Text style={styles.liText}>Account Summary</Text>
                    </View>
                    <View style={styles.li}>
                        <View style={styles.img_cont}>
                            <Cert name="file-certificate-outline" color="black" size={20} />
                        </View>
                        <Text style={styles.liText}>Open Certificates & Deposits</Text>
                    </View>
                    <View style={styles.li}>
                        <View style={styles.img_cont}>
                            <Bar name="credit-card" size={20} color="black" />
                        </View>
                        <Text style={styles.liText}>Payement Services</Text>
                    </View>
                    <View style={styles.li}>
                        <View style={styles.img_cont}>
                            <Credit name="credit-card-alt" size={15} color="black" />
                        </View>
                        <Text style={styles.liText}>Cards Services</Text>
                    </View>
                    <View style={styles.li}>
                        <View style={styles.img_cont}>
                            <Dark name="mobile-alt" size={20} color="black" />
                        </View>
                        <Text style={styles.liText}>Hard Token</Text>
                    </View>
                    <View style={styles.li}>
                        <View style={styles.img_cont}>
                            <Offer name="local-offer" size={20} color="black" />
                        </View>
                        <Text style={styles.liText}>Offers</Text>
                    </View>
                    <View style={styles.li}>
                        <View style={styles.img_cont}>
                            <Contact name="people" size={20} color="black"/>
                        </View>
                        <Text style={styles.liText}>Customer Services</Text>
                    </View>
                    <View style={styles.li}>
                        <View style={styles.img_cont}>
                            <Cal name="calculator" size={20} color="black" />
                        </View>
                        <Text style={styles.liText}>Calculators</Text>
                    </View>
                    <View style={styles.li}>
                        <View style={styles.img_cont}>
                            <Dark name="moon" size={20} color="black" />
                        </View>
                    ...
                    <View style={styles.row}>
                        <View style={styles.cont}>
                            ...
                            <View>
                                ...
                                <Text style={styles.number}>+2{userData.email.split('@')[0]} </Text>
                            </View>
                        </View>
